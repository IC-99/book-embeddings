...
function startProcess() {
    return new Promise((resolve, reject) => {
        ...
        reader.onload = function() {
            try {
                const jsonString = reader.result; // Contenuto del file come stringa
                resolve(jsonString); // Risolve la Promise con la stringa JSON
            } catch (error) {
    ...
    document.getElementById('run').addEventListener('click', function() {
        startProcess()
            .then(jsonString => {
                ...
                console.log('File JSON letto:', jsonString);
                callMain([jsonString]);
            })
            .catch(error => {
